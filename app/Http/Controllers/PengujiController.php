...
class PengujiController extends Controller
{
    ...
    public function tahap2_add(Request $r, $id)
    {
        ...
        return redirect(route('tahap2.create', $id));
    }

    public function tahap2_update(Request $r,  $id)
    {
        $data = Nilai::where('id_industri', $r->id_industri)->where('id_indikator', $id)->first();
        ...
        return redirect(route('tahap2.create', $r->id_industri));
    }
    ...
    public function lap_ahp()
    {
        ...
        return view('penguji.ahp', compact('indikatorall', 'no', 'bobot', 'ci', 'cr'));
    }

    public function lap_akhir()
    {
        $industri = Industri::where('nilai_1', 6)->get();
        $no = 1;
        return view('penguji.lap_akhir', compact('industri', 'no'));
    }
    public function lap_detail($id)
    {
        ...
        return view('penguji.detail_nilai', compact('indikatorall', 'id', 'no', 'bobot', 'ci', 'cr'));
    }
}
